...
#include "interfaces/msg/detail/gate__rosidl_typesupport_fastrtps_c.h"
...
using _Gate__ros_msg_type = interfaces__msg__Gate;
...
static uint32_t _Gate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Gate(
...
static size_t _Gate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Gate(
