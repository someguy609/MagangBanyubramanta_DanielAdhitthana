...
bool camera__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("camera.msg._object.Object", full_classname_dest, 25) == 0);
  }
  camera__msg__Object * ros_message = _ros_message;
  {  // red
...
PyObject * camera__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("camera.msg._object");
