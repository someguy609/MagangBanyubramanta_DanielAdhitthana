...
{
  new (message_memory) interfaces::msg::Gate(_init);
}

void Gate_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::Gate *>(message_memory);
  typed_message->~Gate();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Gate_message_member_array[5] = {
  {
    ...
    offsetof(interfaces::msg::Gate, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::Gate, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::Gate, w),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::Gate, h),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Gate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, Gate)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Gate_message_type_support_handle;
}
