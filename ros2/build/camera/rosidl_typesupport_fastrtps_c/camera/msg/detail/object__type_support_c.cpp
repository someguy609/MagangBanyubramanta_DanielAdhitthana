...
#include "camera/msg/detail/object__rosidl_typesupport_fastrtps_c.h"
...
#include "camera/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Object__ros_msg_type = camera__msg__Object;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_camera
size_t get_serialized_size_camera__msg__Object(
  const void * untyped_ros_message,
...
static uint32_t _Object__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_camera__msg__Object(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_camera
size_t max_serialized_size_camera__msg__Object(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = camera__msg__Object;
    is_plain =
      (
...
static size_t _Object__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_camera__msg__Object(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, camera, msg, Object)() {
