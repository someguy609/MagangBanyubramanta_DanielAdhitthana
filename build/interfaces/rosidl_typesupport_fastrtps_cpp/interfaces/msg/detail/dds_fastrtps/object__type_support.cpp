...
#include "interfaces/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Object *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Object__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Object)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Object__handle;
}
